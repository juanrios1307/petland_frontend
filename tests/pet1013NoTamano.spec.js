...
describe('PET10-1-3 NoTamano', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PET10-1-3 NoTamano', async function() {
    ...
    await driver.findElement(By.css(".ant-anchor-link")).click()
    ...
    await driver.findElement(By.css(".ant-row:nth-child(4) .ant-form-item-control-input")).click()
