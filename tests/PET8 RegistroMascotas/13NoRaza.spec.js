...
describe('1.3 No Raza', function() {
  ...
  it('1.3 No Raza', async function() {
    // Test name: 1.3 No Raza
    ...
    // 7 | click | id=register_color | 
    await driver.findElement(By.id("register_color")).click()
    // 8 | type | id=register_color | Blanca
    ...
    // 14 | runScript | window.scrollTo(0,220) | 
    await driver.executeScript("window.scrollTo(0,220)")
