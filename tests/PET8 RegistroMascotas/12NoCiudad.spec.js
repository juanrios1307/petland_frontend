...
describe('1.2 No Ciudad', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('1.2 No Ciudad', async function() {
    // Test name: 1.2 No Ciudad
    ...
    // 5 | click | id=register_raza | 
    await driver.findElement(By.id("register_raza")).click()
    // 6 | type | id=register_raza | Angus
    ...
    // 14 | click | id=Vaca | 
    await driver.findElement(By.id("Vaca")).click()
