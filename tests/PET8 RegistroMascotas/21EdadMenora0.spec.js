...
describe('2.1 Edad Menor a 0', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('2.1 Edad Menor a 0', async function() {
    // Test name: 2.1 Edad Menor a 0
    ...
    // 17 | click | css=.ant-upload > .ant-upload | 
