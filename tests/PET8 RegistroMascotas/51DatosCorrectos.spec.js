...
describe('5.1 Datos Correctos', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('5.1 Datos Correctos', async function() {
    // Test name: 5.1 Datos Correctos
    ...
    // 17 | click | css=.ant-upload > div > div | 
    await driver.findElement(By.css(".ant-upload > div > div")).click()
    // 18 | runScript | window.scrollTo(0,514) | 
    await driver.executeScript("window.scrollTo(0,514)")
    // 19 | click | css=.ant-col-xs-24 .ant-btn > span | 
